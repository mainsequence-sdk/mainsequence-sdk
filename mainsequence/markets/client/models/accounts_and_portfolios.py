...
from mainsequence.markets.client.models.assets import (
    Asset,
    AssetMixin,
    resolve_asset,
)
from mainsequence.markets.client.models.core import Calendar
    ...
    def add_holdings(
        ...
        *,
        ...
        payload = {
            ...
            "overwrite": overwrite,
            "positions": [
                position.model_dump() if isinstance(position, BaseModel) else position
...
class PortfolioGroup(BaseObjectOrm, BasePydanticModel):
    ...
    def __repr__(self):
        return (
            f"{self.display_name} ({self.unique_identifier}), {len(self.portfolio_uids)} portfolios"
        )
