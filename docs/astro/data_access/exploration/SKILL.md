...
- if the task is about publishing or modifying time-series data, hand off to `docs/astro/data_publishing/data_nodes/SKILL.md`
- if the task is about row-oriented operational data, hand off to `docs/astro/data_publishing/simple_tables/SKILL.md`
