...
- `astro/` state reconciliation after the audit:
...
- assets, VFB, pricing, or dashboard domain issues:
  use the relevant domain skill under `docs/astro/markets_platform/` or `docs/astro/dashboards/`

## Read First

1. `docs/astro/AGENTS.md`
2. `docs/astro/project_builder/SKILL.md`
3. `astro/tasks.md` when it exists
4. `astro/status.md` when it exists
5. `astro/record.md` when stable references or project ids matter
6. `astro/journal.md` when repeated failures or prior investigations may be relevant
...
- `astro/tasks.md` and `astro/status.md` first when they exist
