...
To import a **Fixed‑Weights** portfolio from the Portfolios package:

```python
from mainsequence.markets.portfolios.contrib.signals.fixed_weights import FixedWeights, AUIDWeight
```
...
class BacktestingWeightsConfig(VFBConfigBaseModel):
    ...
    Attributes:
        ...
        signal_weights_instance (SignalWeights):
...
For a deeper explanation of the portfolio construction concepts behind this tutorial, see [Portfolios](../../knowledge/portfolios/index.md).
