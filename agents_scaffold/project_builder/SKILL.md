...
- deciding when `agents_scaffold/` maintenance is required
...
- decide when to hand off to `agents_scaffold/maintenance/local_journal/SKILL.md`
...
- project-state reconciliation and local history under `agents_scaffold/`:
...
2. `agents_scaffold/maintenance/local_journal/SKILL.md`
3. the latest relevant Main Sequence docs for the task
4. `agents_scaffold/brief.md`
5. `agents_scaffold/status.md`
6. `agents_scaffold/tasks.md`
7. `agents_scaffold/record.md`
8. `agents_scaffold/journal.md` when resuming, debugging, or investigating a repeated issue
