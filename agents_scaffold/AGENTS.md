...
how to verify platform behavior, and how to use the project-state files kept under `agents_scaffold/`.

Before any non-trivial Main Sequence work, verify that this `AGENTS.md` matches the latest
version at
`file:/Users/jose/code/MainSequenceClientSide/mainsequence-sdk/agents_scaffold/AGENTS.md`
and that `.agents/skills/mainsequence-project/SKILL.md` matches the latest version at
`file:/Users/jose/code/MainSequenceClientSide/mainsequence-sdk/agents_scaffold/project_builder/SKILL.md`;
...
- when work is delegated or queued for later, write the task in `agents_scaffold/tasks.md` according to the skill that should execute it
- each delegated or queued task in `agents_scaffold/tasks.md` must state:
...
- project scaffolding, folder structure, and standard repository layout:
  `agents_scaffold/project_builder/SKILL.md`
- project-state reconciliation, milestone logging, blocker recording, and next-step updates under `agents_scaffold/`:
  `agents_scaffold/maintenance/local_journal/SKILL.md`
...
- platform data discovery, published table search, and object identification before implementation:
  `agents_scaffold/data_access/exploration/SKILL.md`
...
3. Check `agents_scaffold/status.md` for the latest verified state.
4. Check `agents_scaffold/tasks.md` for current priorities.
5. Check `agents_scaffold/record.md` for project identifiers, checkout path, and orchestration notes.
6. If an error appears, check `agents_scaffold/journal.md` for the same or related error and any prior fix.
...
1. `agents_scaffold/project_builder/SKILL.md`
2. the relevant domain skill
3. `agents_scaffold/maintenance/local_journal/SKILL.md` after material work if verified state, blockers, scope, next actions, stable references, or historical notes changed
...
Always use `agents_scaffold/project_builder/SKILL.md` as the source of truth for project scaffolding, folder structure, and standard repository layout.
...
- append the issue to `agents_scaffold/journal.md`
- add actionable follow-up to `agents_scaffold/tasks.md` if still open
- reflect the latest blocker in `agents_scaffold/status.md`
...
## Project-State Files Under `agents_scaffold/`

The repository keeps project-state files under `agents_scaffold/`:
...
- `agents_scaffold/maintenance/local_journal/SKILL.md` for:
  - `agents_scaffold/brief.md`
  - `agents_scaffold/tasks.md`
  - `agents_scaffold/record.md`
  - `agents_scaffold/status.md`
