...
- read `agents_scaffold/tasks.md` and `agents_scaffold/status.md` first when they exist
...
- `agents_scaffold/` state reconciliation after the audit:
...
- assets, VFB, pricing, or dashboard domain issues:
  use the relevant domain skill under `agents_scaffold/markets_platform/` or `agents_scaffold/dashboards/`

## Read First

1. `agents_scaffold/AGENTS.md`
2. `agents_scaffold/project_builder/SKILL.md`
3. `agents_scaffold/tasks.md` when it exists
4. `agents_scaffold/status.md` when it exists
5. `agents_scaffold/record.md` when stable references or project ids matter
6. `agents_scaffold/journal.md` when repeated failures or prior investigations may be relevant
...
- reading `agents_scaffold/tasks.md` or `agents_scaffold/status.md`
...
- `agents_scaffold/tasks.md` and `agents_scaffold/status.md` first when they exist
