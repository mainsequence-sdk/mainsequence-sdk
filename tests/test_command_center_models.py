...
def test_command_center_models_have_one_canonical_module_and_no_package_shim():
    assert Workspace.__module__ == "mainsequence.client.command_center_models"
    assert ConnectionInstance.__module__ == "mainsequence.client.command_center_models"

    with pytest.raises(ModuleNotFoundError):
        importlib.import_module("mainsequence.client.command_center")
